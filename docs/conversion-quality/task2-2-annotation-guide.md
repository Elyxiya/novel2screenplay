...
**余量缺口**：short 已到 4 本（xiuzhen-short、zhanlan-short、xiuzhen-short2、zhanlan-short2），在满足 3–5 范围的同时向 5 本靠近；medium 已 3 本，均已达标。long 非 2.2 强制项，已按扩展补 1 本长样本完整标注。后续如需扩展可再各补 1–2 本，优先公共版权/自创作文本，原则：**有真实死亡/揭示事件的切片优先**。
