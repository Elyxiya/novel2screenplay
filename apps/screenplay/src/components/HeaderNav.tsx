            ...
            <Link
              ...
              className={`px-3.5 py-2 rounded-xl text-sm flex items-center gap-2 transition-all duration-300 border ${
                pathname?.startsWith('/agent')
                  ? 'bg-gradient-to-r from-fuchsia-600 to-indigo-600 text-white border-transparent shadow-lg shadow-fuchsia-300/50'
                  : 'border-slate-300 bg-white/70 text-slate-500 hover:border-fuchsia-400/60 hover:text-slate-800 hover:shadow-md hover:shadow-fuchsia-100/60'
              }`}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="hidden sm:inline">Agent 对话</span>
            </Link>
            <Link
              href="/shortdrama"
              prefetch={false}
